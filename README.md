...
- 修改了mysql连接密码
- 修改了ssl认证文件等java方法
-在您看了下面的运行忠告过后，也成功在本地启动项目后，注意你访问分类，标签，归档，关于我页面都将失败。
-原因在于：分类，标签页面你目前没有添加，需要在后台管理页面添加了即可访问
-关于本站，关于我页面 我的设计是显示一篇博客，目前你也没有写这两篇博客，自然无法访问。
...
- 要想使得，首页分类，便签页面成功显示，需要后台先创建。
- 要想使得，关于本站，关于我页面成功显示，需要现在后台写好这两篇博客，并且在前端_fragemnts.html中写好对应的博客id即可
